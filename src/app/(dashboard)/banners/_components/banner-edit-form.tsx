...
export function BannerEditForm({ data }: { data: { _id:string; name: string; description: string; image: string; } }) {
...
const { 
  register, 
  handleSubmit, 
  formState : { errors }, control } = useForm ({ resolver : zodResolver(bannerSchema), defaultValues : {
        name : data.name,
...
console.log(data);
  ...
  return (
    <ShowcaseSection title="Edit Banner Form" className="!p-6.5">
      <form onSubmit={handleSubmit(submit)} action="#">
        ...
        <InputGroup
          ...
          label="Banner Name"
          type="text"
          placeholder="Edit your banner name "
          className="mb-4.5"
        />
        ...
        <InputGroup
          ...
          label="Description"
          type="text"
          placeholder="Edit your banner description"
          className="mb-4.5"
        />
